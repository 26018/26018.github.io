...
bool Get_key(char Rec_arr[],char SettingName[],char FileName[])//1.接受数据的数组，2.匹配的设置名称，3.配置文件名
{
	...
	{
		i = 0;
		memset(Setting_Name,&apos\0&apos,sizeof(Setting_Name));
...
bool Put_key(char key[],char value[],char FileName[]) //1.键名，2.键值，3.配置文件名 
{
	char rb[100];
